...
params:
    ...
    weights : "POIDS_init"
    main: "Vico 2022"
    sub: "Dictionnaire des variables" 
    print_table: TRUE
---
...
abstract : "Ce document présente le dictionnaire des variables du fichier `r data`."
---
...
cat(kable(tableau) %>% kable_styling(bootstrap_options = "condensed", latex_options = c("striped", "hold_position"), full_width = T))
...
```{r dico, warning = FALSE, message = FALSE, include = TRUE, echo = FALSE, results = "asis"}
